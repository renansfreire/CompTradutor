import os
import sys
from parser import Parser  # Certifique-se de que parser.py está na mesma pasta
from code_writer import CodeWriter  # Certifique-se de que code_writer.py está na mesma pasta
